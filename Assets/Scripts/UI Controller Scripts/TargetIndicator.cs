...
namespace FlightSim
{
    public class TargetIndicator : MonoBehaviour
    {
        ...
        {
            get { return OutOfSightOffset /* canvasRect.localScale.x*/; }
        }
        ...
        private Vector3 OutOfRangeindicatorPositionB(Vector3 indicatorPosition)
        {
            ...
            if (divX < divY)
            {
                ...
                indicatorPosition.x = Mathf.Sign(indicatorPosition.x) *
                                      (canvasRect.rect.width * 0.5f - outOfSightOffest) * canvasRect.localScale.x;
            ...
            else
            {
                ...
                indicatorPosition.y = Mathf.Sign(indicatorPosition.y) *
                                      (canvasRect.rect.height / 2f - outOfSightOffest) * canvasRect.localScale.y;
